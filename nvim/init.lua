...
require('lazy').setup({
  'tpope/vim-sleuth', -- Detect tabstop and shiftwidth automatically  TODO: check
  ...
  },
  {
    ...
    config = function()
      ...
      -- TODO: check You can press `g?` for help in this menu.
  ...
  { -- Autocompletion
    ...
    opts = {
      ...
      completion = {
        -- TODO: check if set `auto_show = true` to show the documentation after a delay.
